...
> 마지막 갱신: 2026-04-27 (STEP 8 완료 — Statistics 모듈: 직원별 월간 통계 API + 웹 페이지)
...
| GET /stores/statistics/summary | ✅ | 오너 전용 — 전 매장 출근 현황 통합 조회 |
...
| 직원별 근무 통계 페이지 (웹) | ✅ | /statistics 페이지 — 지각·결근·평균 근무시간 테이블 |
